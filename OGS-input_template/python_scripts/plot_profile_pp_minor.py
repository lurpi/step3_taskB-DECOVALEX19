...
polyline="..\\taskB-step3-2d_ply_DIP_Z_minor_t25.tec"
...
for i in range(len(data)):
 x_val= data[i][1][0]
 y_val =data[i][1][2]
 ax1.plot(x_val,y_val,color=colorst[i],lw=2.5,label="Pressure at "+str(data[i][0])+"s")
 
ax1.set_xlabel('Distance along polyline', fontsize=28)
ax1.set_ylabel('Pressure (Pa)', fontsize=28)
