...
ifilename="step3_2d_v4-shift.msh" #generated from .geo file, having physical volumes defined before than surfaces (needed with material_ID)
ofilename="taskB-step3-2d.msh"
...
#*****************************************************************************80
    ...
    ofile.write("%d %d hex %d %d %d %d %d %d %d %d\n" % \
        (cell-1, np.abs(mat-1) , n0, n1, n2, n3, n4, n5, n6, n7)) 
